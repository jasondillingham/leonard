...
| Incident #1 | v0.54 `leonard-hook session-start` runaway: fuzzy-scan cost + truth-dir self-scan + no process deadline → hours at 2 cores, SIGTERM-immune orphan — 1 HIGH, fixed in v0.55.0 | [`incident-1-session-start-runaway.md`](./incident-1-session-start-runaway.md) | (single document) |
